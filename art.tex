...
\newcommand{\addframe}[1] {\includegraphics[page=#1, width=1cm]{thesis_final.pdf}}
...
\begin{tikzpicture}[x=1.6cm,y=2.2cm]
    \foreach \y in {0,...,7}{
        \foreach \x in {1,...,23}{
            \pgfmathsetmacro{\n}{\y*23+\x}
            \node[draw=mygray, line width=0mm, minimum width=1.5cm, minimum height=2.1cm] (i) at (\x, -\y) {\addframe{\n}} ;
        }
    }
\end{tikzpicture}
