    ...
    \begin{table}[htpb]
        ...
        \begin{tabular}{p{0.1\linewidth}p{0.8\linewidth}}
            \cite{defense_youtube} & \tbelt{defense} The video of this thesis defense, which was live-streamed on
                YouTube.\\
            \cite{defense_repository} & \tbelt{manuscript} The repository used for writing this manuscript and the
            slides of the defense. Besides the text and images, it also contains the code and a copy of the data used
