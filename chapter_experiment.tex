...
\label{chapter:experiment:tests}
    ...
    \label{sec:test:implementation}
        ...
        \label{sub:workflow}
            ...
            The workflow, illustrated in Figure~\ref{fig:experiment:g5k_test:workflow}, consists in three main steps.
            The first one is implemented with \peanut while the two others are implemented with \cashew.
            \begin{description}
