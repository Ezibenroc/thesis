...
\label{chapter:experiment:randomizing}
    ...
    \label{sec:randomizing_data}
        ...
        \section{Testing the bit-flip hypothesis}
            ...
            completely random, then we apply a mask so that the right-most bits (in green) become deterministic.
            Several mask sizes have been tested, from 0 (the elements are left unchanged) to 53 (the mantissa becomes
            completely deterministic, all the elements are equal).
            \begin{figure}[htpb]
                \begin{center}
