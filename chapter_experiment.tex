...
\label{chapter:experiment:randomizing}
    ...
    \label{sec:randomizing_sizes}
        ...
        \label{sub:effect_of_the_experiment_file}

            \begin{figure}[htpb]
                \centering
                \includegraphics[width=\linewidth]{img/experiment/randomizing_sizes/average_performance.pdf}
            ...
            \begin{figure}[htpb]
                \centering
                \includegraphics[width=\linewidth]{img/experiment/randomizing_sizes/average_distribution.pdf}
