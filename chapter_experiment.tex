...
\label{chapter:experiment:tests}
    ...
    \section{State of the art}%
        ...
        use a wide variety of techniques and methodologies to ensure (or at least limit) the presence of bugs.

        Performance testing is less common, probably due to several reasons:
        \begin{itemize}
