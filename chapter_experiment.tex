...
\label{chapter:experiment:testbed}
    ...
    \label{sec:peanut}
        ...
        \label{sub:comparison_with_execo}
            ...
            Run with: \verb#python script.py#\\

            \lstinputlisting[language=Python,
                caption={Small experiment example using Peanut}\label{lst:engine:peanut_simple}]{
                img/experiment/engine/mwePeanut_simple.py
            }
            ...
            \lstinputlisting[language=Python,
                caption={Small experiment example using Peanut (2)}\label{lst:engine:peanut_class}]{
            ...
            \lstinputlisting[language=Python,
                caption={Small experiment example Execo}\label{lst:engine:execo}]{
