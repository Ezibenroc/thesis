    ...
    \label{sec:test_implementation}
        ...
        \label{sub:workflow}
            ...
            \subsubsection{Statistical test computation}%
                ...
                The implementation directly follows the formula described in \ref{sub:statistical_test}. It relies
                heaviliy on Numpy and Pandas for a better efficiency.
        ...
        \label{sub:presentation_of_the_test_results}
            ...
            \begin{figure}[htpb]
                ...
                \caption{Evolution of the test result for the mean performance on two nodes of cluster \emph{dahu}}%
