...
\label{chapter:experiment:difficulties}
    ...
    \label{sec:beware_of_extrapolations}
        ...
        because of a wrong extrapolation. The measures made for instanciating the model were made with parameters that
        ...
        \begin{description}
            \item[Function \dgemm] The model used to be instanciated using the durations of \dgemm calls made with
            ...
            \item[Functions \recv and \send] In the legacy script for calbrating MPI communications for Simgrid, the
        ...
        the execution. One way to limit the risk of missing such extrapolations would be to define explicitely in the
    ...
    \label{sec:beware_of_experimental_conditions}
        ...
        close as possible to what happens in the real application we tried to modelize, HPL in this case.
...
\label{chapter:experiment:tests}
        ...
        \label{sub:on_the_normality_assumption}
            ...
            \begin{itemize}
                ...
                \item The Model factors (\eg MNK) are coefficients of an ordinary least-square linear regression (OLS).
                    ...
                    \(\bm{y}\) the vector of observed durations, the vector of regression coefficients
        ...
        \label{sub:detected_events}
            ...
            \subsubsection{BIOS upgrade}%
                ...
                \begin{itemize}
                    ...
                    \item On 2020/06/10, cluster \emph{gros}. All the nodes of the cluster had a performande drop of
            ...
            \subsubsection{Faulty memory}%
                ...
                Occasionnaly, some nodes became extremely slow. The performance difference was so large that our test
                ...
                calling the function \texttt{memset} on all the cores of the node silmutaneously. Each time, it was
                located on a single processor of the node, the other processor was functionning normally.
            ...
            \subsubsection{Power unstability}%
                ...
                n°0 consummed only \NSI{97.5}{\watt}. For reasons we ignore, such power drops happened particuliarly
            ...
            \subsubsection{Other issues}%
                ...
                \begin{table}[htpb]
                    ...
                    \begin{tabular}{l|lll}
                        ...
                        \emph{grisou-12} & 2020/08/06 & NA & \NSI{15}{\celsius} \\
    ...
    \label{sec:test:conclusion}
        ...
        even nodes that were literraly unusable when their memory was under heavy load. These events went unnoticed by
        ...
        reimplemented with other more suitable technologies, for instance the data should be stored with a proper
        database management system. There also remains some automations to implement, in particular the scheduling of
