...
\label{chapter:experiment:randomizing}
        ...
        \subsection{Function \dgemm}%
            ...
            \begin{description}
                \item[Independent sizes] Each of the three sizes \(M\), \(N\) and \(K\) is sampled independently and
                    ...
                    \(MNK\) is not uniform, it is heavily skewed towards the small values.
                \item[Uniform product] The product \(MNK\) is sampled uniformly in some interval, and then the sizes
                    ...
                    procedure, since they are not generated independently from each other. Additionaly, we use rejection
    ...
    \label{sec:randomizing_order}
        ...
        \NSI{900}{\byte} and \NSI{1000}{\byte}. Each point is the duration of an individual call to \recv,
        ...
        \begin{figure}[htpb]
            ...
            \caption{The duration of \recv is not identically distributed in the non-shuffled case.
        ...
        occurence of this issue, a possible reason may be that the individual calls to \recv are not truly
