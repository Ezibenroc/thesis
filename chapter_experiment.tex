    ...
    \label{sec:test_implementation}
        ...
        \label{sub:workflow}
            ...
            \subsubsection{Experiment execution}%
                ...
                The experiment script is written in Python and uses the Peanut experiment engine (see
                ...
                \begin{enumerate}
                    ...
                    \item Collect the resulting data (\dgemm durations and monitoring values) and meta-data (system
                        files, software versions, etc.) and build an archive.
