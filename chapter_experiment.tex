    ...
    \label{sec:test_implementation}
        ...
        \label{sub:workflow}
            ...
            \subsubsection{Archive extraction and aggregation}%
                ...
                \begin{itemize}
                    \item The possibility to append data to a file. With Appache Arrow, for each new experiment we would
                        have to read the whole file in memory to add the new data.
                    \item The ability to load only a subset of the data based on a predicate. For instance, it is
                        possible to load the measures made on a given node between two given dates without having to
                        read the whole file.
                \end{itemize}
