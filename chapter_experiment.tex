...
\label{chapter:experiment:tests}
    ...
    %% automatiquement.
        When working on the simulations described in Part~\ref{part:prediction}, we occasionnaly encountered
        inconsistent performance. The reasons are multiple, ranging from the hardware to the software. This motivated
        the implementation of performance non-regression tests, to help us detect any noteworthy change on the platform.
        This chapter describes the existing state of the art, the statistics we based our work on and how we implemented
        the tests. We also list several performance changes we noticed on Grid'5000 clusters during this work.
    ...
    \section{State of the art}%
        ...
        \label{sub:existing_tools}
            ...
            Some text, citing Google Benchmark\cite{google-benchmark}
