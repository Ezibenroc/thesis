...
\label{chapter:experiment:tests}
    ...
    \label{sec:test_implementation}
        ...
        \label{sub:presentation_of_the_test_results}
            ...
            (\NSI{99.99}{\percent} in this figure). It is computed using all the previous observations that were made
            after the last change. In other words, each time we recognise a change and add a vertical line, the
            fluctuation interval gets reseted.
