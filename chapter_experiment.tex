    ...
    \label{sec:test:implementation}
        ...
        \label{sub:presentation_of_the_test_results}
            ...
            \subsubsection{Evolution plot}%
                ...
                \begin{figure}[htpb]
                    \centering
                    \subfigure[Performance evolution of node \dahu-14\label{fig:experiment:non_regression:evolution_dahu14}]{
                        \includegraphics[width=\linewidth]{img/experiment/non_regression/implementation/evolution_dahu-14.pdf}
                    }
                    \subfigure[Performance evolution of node \dahu-26\label{fig:experiment:non_regression:evolution_dahu26}]{
            ...
            \subsubsection{Windowed test}%
                ...
                \begin{figure}[htpb]
                    ...
                    \subfigure[Performance evolution of node
                        \dahu-14\label{fig:experiment:non_regression:evolution_dahu14_windowed}]{
                        \includegraphics[width=\linewidth]{img/experiment/non_regression/implementation/evolution_dahu-14_windowed.pdf}
                    }
                    \subfigure[Performance evolution of node
                    \dahu-26\label{fig:experiment:non_regression:evolution_dahu26_windowed}]{
        ...
        \label{sub:detected_events}
            ...
            several months (from July 2019 to February 2021 for \dahu, the first cluster we started to monitor).
