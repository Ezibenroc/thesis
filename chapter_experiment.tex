    ...
    \label{sec:test_implementation}
        ...
        \label{sub:workflow}
            ...
            \subsubsection{Statistical test computation}%
                ...
                test does not need the full repository, it automatically downloads the required files. As for the
                previous step, the test is implemented in Cashew and use a Jupyter notebook.
        ...
        \label{sub:presentation_of_the_test_results}
            ...
            \begin{figure}[htpb]
                ...
                \caption{Landing page of the test webpage. Each cluster is represented by a row, each factor by a
                ...
                multi-dimensional test made on all these coefficients together.}%
                \label{fig:img:experiment:non_regression:home}
            \end{figure}
