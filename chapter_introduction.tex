...
\label{chapter:context}
    ...
    \label{sec:first_computers}
        ...
        \todo{Add some text on the first mechanical computers, the human computers at NASA, the first IBM computer.}
    ...
    \label{sec:exponential_growth}
        ...
        \begin{figure}[htbp]
            ...
            Evolution of the processor characteristics in the last 49 years. Plot inspired from the work of Pedro Bruel,
            generated with data from wikipedia.}
        \end{figure}
