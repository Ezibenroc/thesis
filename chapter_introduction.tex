...
\label{chapter:context}
    ...
    \label{sec:first_computers}
        ...
        In the same period, a French inventor named Thomas de Colmar designed and manufactured the first digital
        mechanical calculator, called arithmometer. Similarly, Herman Hollerith, an American inventor, created the
        tabulating machine. Initialy built to process the 1890 US Census data, it worked by reading and summarizing
        information stored in punched cards. These two last inventions~\cite[Chapter~6]{human_computers} were commercial
