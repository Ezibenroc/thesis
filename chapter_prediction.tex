...
\label{chapter:prediction:related_work}
    ...
    \label{sec:simgrid_smpi}
        ...
        With SMPI, the user is responsible for instanciating the model, \ie they have to provide the aforementionned
...
\label{chapter:prediction:hpl}
    ...
    \label{sec:hpl:benchmark}
        ...
        The \emph{panel} mentionned in Figure~\ref{fig:hpl_overview} is an intricate data structure used throughout
...
\label{chapter:prediction:modeling}
    ...
    \section{Conclusion}%
        ...
        difficulty resides in instanciating the models, \ie computing the best fit for some observations, in the most
