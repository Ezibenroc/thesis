    ...
    \label{sec:network_model}
        ...
        \label{sub:pytree}
            ...
            \subsubsection{Model}%
                ...
                The concatenation of lists will be noted \(\ell_1 \cdot \ell_2\), hence
                \(\text{BIC}(\ell_1\cdot\ell_2)\) will denote the BIC of a linear regression without breakpoint
                (\(N=0\)).
            ...
            \subsubsection{Main algorithm}%
                ...
                In the bottom-up step, adjacent intervals are greedily merged (thereby removing breakpoints), starting
                by fusions that decrease the least the RSS. All the different iterations of the loop are kept in memory,
                the merging operation is carried until there is no breakpoint left. In the end, we keep the iteration
                that minimized the BIC.
                \begin{algorithm}
                    \DontPrintSemicolon
                    ...
                    \Fn{\Fbottomup{\(L = (\ell_1,\dots,\ell_{N})\)}}{
                        ...
                        \For{\(i=1\) \KwTo \(N-1\)}{
                            ...
                            \(n = N-i\)\;
                            \For{\(j=1\) \KwTo \(n-1\)}{
                                \(\text{new\_diff} = \text{RSS}(\ell_j \oplus \ell_{j+1}) - \left(\text{RSS}(\ell_j) +
                            ...
                            \(L = (\ell_1,\dots,\ell_{k}\oplus\ell_{k+1},\dots,\ell_n)\)\;
                            add \(L\) to \(S\)\;
                        }\;
