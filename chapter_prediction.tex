        ...
        \begin{landscape}
            ...
            \begin{table}[htpb]
                ...
                \begin{tabular}{p{0.15\linewidth} | p{0.13\linewidth} p{0.13\linewidth} p{0.13\linewidth} p{0.13\linewidth}
                    ...
                    & Extrapolation on the problem size & Extrapolation on the configuration & No full-scale real
                    run & Hypothetical platform & Efficiency & Accuracy\\
                    Analytical model          & \yess & \yess & \yess & \yess & \yess \yess & \nope\nope\\
                    \cite{hpl_prediction}   & \yess & \nope & \yess & \nope & \yess & \yess\\
                    \cite{Singh_2007}       & \nope & \yess & \nope & \nope & \yess & \yess\\
                    Off-line simulation     & \nope & \nope & \nope & \yess & \yess & \yess\\
                    On-line simulation      & \yess & \yess & \yess & \yess & \yess & \yess\\
                \end{tabular}
            \end{table}
        \end{landscape}
