                    ...
                    \Fn{\Ftopdown{\(\ell\)}}{
                        ...
                        \ForEach{\((X,Y) \in \ell\)}{
                            ...
                            \If{\(\text{new\_BIC} < \text{best\_BIC}\)}{
                                ...
                                \(\text{best\_solution} = (\ell_1, \ell_2, X)\)\;
                            }\;
                        }\;
                        \uIf{\(\text{new\_BIC} < \text{BIC}(\ell)\)}{
                            \((\ell_1, \ell_2, X) = \text{best\_solution}\)\;
                            \(\text{breaks}_1\) = \Ftopdown{\(\ell_1\)}\;
                            \(\text{breaks}_2\) = \Ftopdown{\(\ell_2\)}\;
                            \KwRet{\(\text{breaks}_1 \oplus (X) \oplus \text{breaks}_2\)}\;
                        }
                        \Else{
                            \KwRet{\(\emptyset\)}\;
                        }
