    ...
    \label{sec:network_model}
        ...
        \label{sub:pytree}
            ...
            \subsubsection{Main algorithm}%
                ...
                In the top-down step (Algorithm~\ref{algo:pytree:topdown}), we recursively build a tree, where the inner
                ...
                In the bottom-up step (Algorithm~\ref{algo:pytree:bottomup}), adjacent intervals are greedily merged
            ...
            \subsubsection{Objective function}%
                ...
                \end{equation}
                Likewise, the value \(\text{BIC}_\log\) is naturally defined based on \(\text{RSS}_\log\).
