    ...
    \label{sec:dgemm_model}
        ...
        \label{sub:dgemm_model:generative_models}
            ...
            \begin{figure}[pt]
                ...
                \caption{Distribution of the regression parameters for around 20 \texttt{dgemm} calibrations made on
                ...
                \caption{Distribution of the regression parameters for around 20
                    \texttt{dgemm} calibrations made on each of the 32 nodes. 4 of
    ...
    \label{sec:different_problem_sizes}
        ...
        \begin{figure}[htpb]
            ...
            \begin{tikzpicture}
                ...
                {\hbox{\hspace{-.05\linewidth}\resizebox{0.9\linewidth}{!}{\input{img/prediction/validation/matrix_size/validation_performance.tex}}\hspace{-.05\linewidth}}};
                \draw[-latex] (11.6, 7) to[bend left] node [midway, right, model_label, anchor=west] {\textbf{(1)}}
                (11.6, 6) ;
                \draw[-latex] (11.6, 6) to[bend left] node [midway, right, model_label, anchor=west] {\textbf{(2)}}
                (11.6, 5.5) ;
                \node[model_label, fill=white] at (10, 3.8) {\textbf{(1)} spatial var.};
                \node[model_label, fill=white] at (10, 3.4) {\textbf{(2)} temporal var.};
            \end{tikzpicture}
