...
df['transistors'] = float('nan')
df.loc[~df['Transistors'].isna(), 'transistors'] = df['Transistors']
df.loc[~df['Transistors(millions)'].isna(), 'transistors'] = df['Transistors(millions)']*1e6
...
def parse_unit(df, colname, unit, new_name):
    ...
    result = df[colname].astype(str).str.extract(reg)
...
df = df[['date', 'processor', 'designer', 'frequency', 'word_size', 'transistors', 'frequency_min',
...
#+RESULTS:
: Pandas version 1.2.1
: Dataframe of 212 rows and 14 columns
:    date processor   designer frequency  word_size  transistors  frequency_min  frequency_max  process_min  process_max  core_per_die_min  core_per_die_max  die_per_module_min  die_per_module_max
: 0  1971      4004      Intel   740 kHz        4.0       2250.0       740000.0       740000.0      0.00001      0.00001               NaN               NaN                 NaN                 NaN
: 1  1972    PPS-25  Fairchild   400 kHz        4.0          NaN       400000.0       400000.0          NaN          NaN               NaN               NaN                 NaN                 NaN
: 2  1972    μPD700        NEC       NaN        4.0          NaN            NaN            NaN          NaN          NaN               NaN               NaN                 NaN                 NaN
: 3  1972      8008      Intel   500 kHz        8.0       3500.0       500000.0       500000.0      0.00001      0.00001               NaN               NaN                 NaN                 NaN
: 4  1972     PPS-4   Rockwell   200 kHz        4.0          NaN       200000.0       200000.0          NaN          NaN               NaN               NaN                 NaN                 NaN
