...
draw_plot <- function(center, shape, radius, new_points, old_radius=NA, nb_points=1000, seed=42) {
    set.seed(seed)
...
#+RESULTS:
[[file:/tmp/babel-LlZHec/figureMla9Ic.png]]
**** Multiple points
#+begin_src R :results output graphics :file (org-babel-temp-file "figure" ".png") :exports both :width 600 :height 400 :session *R*
set.seed(230)
nb_points = 5
...
plot = draw_plot(mu, sigma, radius_multiple, new_points, old_radius=radius)
#ggsave(filename='img/experiment/non_regression/statistics/single_point.pdf', plot=plot, width=7, height=5)
plot
#+end_src

#+RESULTS:
[[file:/tmp/babel-LlZHec/figure8Q0wqK.png]]
