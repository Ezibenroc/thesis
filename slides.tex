...
\begin{frame}{Scientific computing}
    ...
    Today, no science without computing
    \pause

    Computer performance improvements mainly driven by increased complexity
\end{frame}
...
\begin{frame}[plain]
    \begin{LARGE}
        Goal: \alert{\textbf{predict}} the performance of a parallel application \\
    \end{LARGE}
    \vfill
    \pause
    \begin{block}{Thesis contribution}
        \begin{itemize}
            ...
            \item Skip the expensive computations (mostly \dgemm) and replace them by a performance model
