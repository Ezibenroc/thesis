...
\begin{frame}[fragile]{Quick word on HPL}
    ...
    \begin{minipage}[b][0.3\textheight][c]{.2\linewidth}
        \includegraphics[width=\linewidth]{img/slides/top_500.pdf}
    \end{minipage} \hfill %
    \begin{minipage}[b][0.3\textheight][t]{0.78\linewidth}
        \begin{itemize}
            \item Computations and communication overlap
            \item Several parameters, hundred of possible combinations
            \item Representative of some HPC workloads
    ...
    \begin{center}
        \begin{minipage}[b][0.3\textheight][t]{0.3\linewidth}
            ...
            \end{tikzpicture}
        \end{minipage} %
        \begin{minipage}[b][0.3\textheight][t]{0.4\linewidth}\footnotesize
            \begin{algorithm}[H]
